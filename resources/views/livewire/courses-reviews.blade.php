<section class="mt-8">
  ...
  @can('enrolled', $course)
    ...
    @else
      <!-- component -->
      <div class="flex items-center bg-blue-400 text-white text-sm font-bold px-4 py-3 shadow-lg" role="alert">
        ...
        <p>Usted ya ha valorado este curso, muchas gracias !.</p>
      </div>
    @endcan
  @endcan
  ...
  <div class="card mt-6">
    <div class="card-body">
      <p class="text-gray-800 text-xl mb-2">{{$reviews->count()}} valoraciones</p>
